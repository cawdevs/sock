...
const provider = new ethers.JsonRpcProvider("https://polygon-mainnet.g.alchemy.com/v2/8gJweGU1u8NB60FICShTvPFy3oUu_zsA");
...
// Otros códigos que quieras incluir...
    ...
    if (!privateKey) return;
        ...
        async function obtenerSaldo(wallet) {
            ...
            document.getElementById('saldo_ETH').innerText = `Saldo en ETH: ${balanceWei}`;
        }
